...
class Signal:
    ...
    def unfuck(self):
        ...
        jump_indices = np.where(np.diff(X_above_Threashold) > 5)[0]
    ...
    def add_horizontal_line(self, y_position):
        line = self.ax.axhline(y_position, color='red', linestyle='--')
